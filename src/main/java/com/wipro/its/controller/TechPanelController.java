...
public class TechPanelController {
    ...
    public ResponseEntity<ApiResponse<List<InterviewScheduleResponse>>> getMyInterviews(
        ...
        List<InterviewScheduleResponse> interviews =
                interviewScheduleService.getByTechPanel(userDetails.getUsername());
    ...
    public ResponseEntity<ApiResponse<InterviewScheduleResponse>> submitRating(
        ...
        return ResponseEntity.ok(ApiResponse.success("Tech rating submitted",
                interviewScheduleService.submitTechRating(id, request)));
    }
}
